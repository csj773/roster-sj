// ==================== gcal.js (optimized + rate-limit safe) ====================
import fs from "fs";
...
// ------------------- 날짜별 이벤트 캐시 & 최적화된 timestamp 중복 체크 -------------------
const eventsCache = {};
